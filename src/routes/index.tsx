...
function Logo({ className = "h-28", subtitle }: { className?: string; subtitle?: string }) {
  return (
  ...
  return (
    ...
    >
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-sage text-white shadow-2xl ring-1 ring-white/20 transition-all duration-300 hover:scale-110 hover:bg-sage/90 active:scale-95"
